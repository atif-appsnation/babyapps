...
<head>
    ...
    <title>Kiddino - Children School & Kindergarten HTML Template - Event Details</title>
...
============================== -->
    ...
    <section class=" space">
        <div class="container">
            <span class="sec-subtitle">24 December, 2023</span>
            <h2 class="h1 mt-n2 mb-4">Father`s Day Sundaes & Shaving!</h2>
            <div class="row mb-2 mb-lg-4">
                <div class="col-md-7 col-lg-6 mb-30 mb-sm-0">
                    <h3 class="h4">Event Countdown</h3>
                    <div class="title-divider1"></div>
                    <div class="countdown-style1">
                        <ul class="countdown-active" data-end-date="01/12/2024">
                            <li><span class="day">127</span>Days</li>
                            <li><span class="hour">20</span>Hours</li>
                            <li><span class="minute">30</span>Minutes</li>
                            <li><span class="seconds">13</span>Seconds</li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-5 col-lg-6">
                    <h3 class="h4">Coordinator</h3>
                    <div class="title-divider1"></div>
                    <h4 class="text-theme mt-n2">Prof. Jessica Thomas</h4>
            ...
            <h2>Event Details</h2>
            <div class="title-divider1"></div>
            <p>We are constantly expanding the range of services offered, taking care of children of all ages. Our goal
                is to carefully educate and develop children in a fun way. We strive to turn the learning process into a
                bright event so that children study with pleasure. We are constantly expanding the range of services
                offered, taking care of children of all ages. Our goal is to carefully educate and develop children in a
                fun way. We strive to turn the learning process into a bright event so that children study with
                pleasure. We are constantly expanding the range of services offered, taking care of children of all
                ages. Our goal is to carefully educate and develop children in a fun way. We strive to turn the learning
                process into a bright event so that children study with pleasure. We are constantly expanding the range
                of services offered, taking care of children of all ages. Our goal is to carefully educate and develop
                children in a fun way. We strive to turn the learning process into a bright event so that children study
                with pleasure.</p>
            ...
            <div class="accordion accordion-style1" id="faqVersion3">
                ...
                <div class="accordion-item">
                    <div class="accordion-header" id="headingFive4">
                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                            data-bs-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive4">
            ...
            <h2 class="mt-5">Event Location</h2>
            <div class="title-divider1"></div>
