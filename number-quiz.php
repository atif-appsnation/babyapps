...
<head>
    ...
    <title>Number Quiz - Baby Apps</title>
    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Number Quiz</h1>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.babypps.kids.Counting.NumberQuiz" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/number-quiz/number-quiz-01.webp" class="img-fluid" alt="Number Quiz"></div>
                                <div><img src="assets/img/games/number-quiz/number-quiz-02.webp" class="img-fluid" alt="Number Quiz"></div>
                                <div><img src="assets/img/games/number-quiz/number-quiz-03.webp" class="img-fluid" alt="Number Quiz"></div>
                                <div><img src="assets/img/games/number-quiz/number-quiz-04.webp" class="img-fluid" alt="Number Quiz"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Number Quiz is a playful and educational number game designed for young learners. Perfect for kids ages 3–7, this game helps children develop early math skills like number recognition, counting, and comparing quantities — all through colorful visuals and simple tap controls.</p>
                                ...
                                <h4>How to Play:</h4>
                                    <ul>
                                        <li><b>Level 1: </b>Match the number you see on screen</li>
                                        <li><b>Level 2: </b>Count all objects in a group</li>
                                        <li><b>Level 3: </b>Count only the specific object shown</li>
                                        <li><b>Level 4: </b>Choose the number that appears most often</li>
                                    </ul>
                                <h4>What Kids Learn:</h4>
                                <ul>
                                    <li>Number recognition</li>
                                    <li>Counting skills</li>
                                    <li>Object differentiation</li>
                                    <li>Quantity comparison.</li>
                                    <li>Visual memory & observation.</li>
                                </ul>
                                <h4>Features:</h4>
                                <ul>
                                    <li>Progressive difficulty across 4 fun levels.</li>
                                    <li>Bright, colorful graphics to keep kids engaged.</li>
                                    <li>Designed for independent play — no reading required.</li>
                                    <li>Ideal for preschool, kindergarten, or home learning environments.</li>
                                    <li>Whether your child is just starting to learn numbers or practicing their counting skills, Number Quiz offers a fun and interactive way to build foundational math knowledge.</li>
                                </ul>
                                <h4>About the Developer:</h4>
                                <p>Number Quiz is part of the BabyApps learning series, created in collaboration with AppsNation and AppexGames. We create safe, developmentally appropriate digital tools that support learning through play for young children.</p>
                            </div>
