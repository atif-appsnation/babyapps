...
<head>
    ...
    <title>Color Bestie - Baby Apps</title>
    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Color Bestie</h1>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.babyapps.kids.coloringgame.colorbestie" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/color-bestie/color-bestie-01.webp" class="img-fluid" alt="Color Bestie"></div>
                                <div><img src="assets/img/games/color-bestie/color-bestie-02.webp" class="img-fluid" alt="Color Bestie"></div>
                                <div><img src="assets/img/games/color-bestie/color-bestie-03.webp" class="img-fluid" alt="Color Bestie"></div>
                                <div><img src="assets/img/games/color-bestie/color-bestie-04.webp" class="img-fluid" alt="Color Bestie"></div>
                                <div><img src="assets/img/games/color-bestie/color-bestie-05.webp" class="img-fluid" alt="Color Bestie"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Color Bestie is a fun, educational coloring and puzzle game designed to support early childhood development. Built for toddlers, preschoolers, and young kids aged 3 to 8, the game encourages creativity, problem-solving, and fine motor skill development in a safe, ad-free environment.</p>
                                <p>Children can enjoy a variety of interactive activities, including color-based puzzles, themed coloring pages, and a free drawing mode. Each tap inspires imagination and learning through joyful, age-appropriate play.</p>
                                <h4>What Kids Can Learn:</h4>
                                    <ul>
                                        <li><b>Color Recognition:</b> Match colors to objects and complete visual puzzles.</li>
                                        <li><b>Cognitive Skills:</b> Enhance shape recognition, memory, and logic.</li>
                                        <li><b>Creative Expression:</b> Explore drawing with crayons, brushes, and glitter tools.</li>
                                        <li><b>Play-Based Learning:</b> Progress through fun and increasingly challenging levels.</li>
                                    </ul>
                                <h4>Features:</h4>
                                <ul>
                                    <li><b>Color Puzzle Mode:</b> Solve interactive, color-themed challenges.</li>
                                    <li><b>Free Drawing Canvas:</b> Open-ended art creation for kids.</li>
                                    <li><b>Diverse Coloring Pages:</b> Includes animals, nature, food, and more.</li>
                                    <li><b>Offline & Ad-Free:</b> No ads or pop-ups, designed for safe play.</li>
                                    <li><b>Friendly Audio Feedback:</b> Positive sounds and music enhance the experience.</li>
                                    <li><b>Age-Appropriate Design:</b> Perfect for ages 3 to 8.</li>
                                </ul>
                                <p>Color Bestie is part of the BabyApps early learning collection, created by AppsNation and AppexGames — developers of family-friendly digital experiences designed to nurture curiosity and creativity in young learners.</p>
                                <p>Download Color Bestie to explore a colorful world of creativity and learning!</p>
                            </div>
