...
<head>
    ...
    <title>Kiddino - Children School & Kindergarten HTML Template - Teacher Details</title>
    ...
    <div class="breadcumb-wrapper " data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Teacher Details</h1>
        ...
        <div class="container">
            <div class="row gx-50 ">
                <div class="col-lg-6 col-xxl-auto">
                    <div class="img-box7">
                        <div class="mega-hover"><img class="w-100" src="assets/img/team/t-d-1-1.jpg" alt="teacher">
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 align-self-center">
                    <div class="team-about">
                        <h2 class="team-name">Katie Willmore</h2>
                        <p class="team-degi">Principal and Manager</p>
                        <h3 class="inner-title">Qualifications </h3>
                        <div class="title-divider2"></div>
                        <p class="team-text">MS/Mphil degree, PhD degree</p>
                        <div class="row gx-80">
                            <div class="col-md-6 col-lg-auto">
                                <h3 class="inner-title">Working Hours</h3>
                                <div class="title-divider2"></div>
                                <p class="team-time">Monday to Friday: <strong>8.30am – 02.00pm</strong></p>
                                <p class="team-time">Saturday, Sunday: Close</p>
                                <div class="team-info"><i class="fas fa-envelope"></i>Email: <a class="text-inherit"
                                        href="mailto:user@example.com">user@example.com</a></div>
                                <div class="team-info"><i class="fas fa-mobile-alt"></i>Phone: <a class="text-inherit"
                                        href="tel:+4402076897888">+44 (0) 207 689 7888</a></div>
                            </div>
                            <div class="col-auto">
                                <h3 class="inner-title">Social Sharing</h3>
                                <div class="title-divider2"></div>
                                <div class="vs-social">
            ...
            <div class="team-description">
                ...
                <div class="title-divider2"></div>
                <p>We are constantly expanding the range of services offered, taking care of children of all ages. Our
                    goal is to carefully educate and develop children in a fun way. We strive to turn the learning
                    process into a bright event so that children study with pleasure. We are constantly expanding the
                    range of services offered, taking care of children of all ages. Our goal is to carefully educate and
                    develop children in a fun way. We strive to turn the learning process into a bright event so that
                    children study with pleasure. We are constantly expanding the range of services offered, taking care
                    of children of all ages. Our goal is to carefully educate and develop children in a fun way. We
                    strive to turn the learning process into a bright event so that children study with pleasure. We are
                    constantly expanding the range of services offered, taking care of children of all ages. Our goal is
                    to carefully educate and develop children in a fun way. We strive to turn the learning process into
                    a bright event so that children study with pleasure.</p>
                <p>Our goal is to carefully educate and develop children in a fun way. We strive to turn the learning
                    process into a bright event so that children study with pleasure. We are constantly expanding the
                    range of services offered, taking care of children of all ages. Our goal is to carefully educate and
                    develop children in a fun way. We strive to turn the learning process into a bright event so that
                    children study with pleasure.</p>
            </div>
        </div>
    </section><!--==============================
   Service Area  
==============================-->
            ...
            <div class="row gx-80 gy-30 pt-lg-2">
                <div class="col-md-6 col-lg-4">
                    <div class="service-style2">
                        ...
                        <div class="service-content">
                            <h3 class="service-title"><a class="text-inherit" href="service-details.html">Learning &
                                    Fun</a></h3>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style2">
                        ...
                        <div class="service-content">
                            <h3 class="service-title"><a class="text-inherit" href="service-details.html">Healthy
                                    Meals</a></h3>
                            <p class="service-text">Our goal is to carefully educate and develop children in a fun way.
                                We strive learning process into a bright.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style2">
                        ...
                        <div class="service-content">
                            <h3 class="service-title"><a class="text-inherit" href="service-details.html">Children
                                    Safety</a></h3>
                            <p class="service-text">Our goal is to carefully educate and develop children in a fun way.
                                We strive learning process into a bright.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style2">
                        ...
                        <div class="service-content">
                            <h3 class="service-title"><a class="text-inherit" href="service-details.html">Cute
                                    Environment</a></h3>
                            <p class="service-text">Our goal is to carefully educate and develop children in a fun way.
                                We strive learning process into a bright.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style2">
                        ...
                        <div class="service-content">
                            <h3 class="service-title"><a class="text-inherit" href="service-details.html">Varied
                                    Classes</a></h3>
                            <p class="service-text">Our goal is to carefully educate and develop children in a fun way.
                                We strive learning process into a bright.</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-style2">
                        ...
                        <div class="service-content">
                            <h3 class="service-title"><a class="text-inherit" href="service-details.html">Full Day
                                    Sessions</a></h3>
                            <p class="service-text">Our goal is to carefully educate and develop children in a fun way.
                                We strive learning process into a bright.</p>
                        </div>
    ...
    Testimonial Area
    ==============================-->
    <section class=" pt-5 pt-md-3 mt-1 space-extra-bottom">
        <div class="container text-center text-md-start">
    ...
    Call To Action
    ==============================-->
    <section class=" space-extra" data-bg-src="assets/img/bg/cta-bg-1-1.jpg">
        <div class="container">
            <div class="cta-box1">
                <h2 class="cta-title">Join together to make amazing things happen</h2>
                <p class="cta-text">Get all the latest information, support and guidance about the cost of living with
                    kindergarten.</p>
