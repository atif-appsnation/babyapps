...
<head>
    ...
    <title>Shadow Match Up - Baby Apps</title>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.babyapps.shadow.matchinggame.shadowmatchup" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/shadow-match-up/shadow-match-up-01.webp" class="img-fluid" alt="Shadow Match Up"></div>
                                <div><img src="assets/img/games/shadow-match-up/shadow-match-up-02.webp" class="img-fluid" alt="Shadow Match Up"></div>
                                <div><img src="assets/img/games/shadow-match-up/shadow-match-up-03.webp" class="img-fluid" alt="Shadow Match Up"></div>
                                <div><img src="assets/img/games/shadow-match-up/shadow-match-up-04.webp" class="img-fluid" alt="Shadow Match Up"></div>
                                <div><img src="assets/img/games/shadow-match-up/shadow-match-up-05.webp" class="img-fluid" alt="Shadow Match Up"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Discover Shapes, Shadows, and Smart Thinking!</p>
                                <p>Shadow Match Up is a delightful and educational shadow puzzle game where children match familiar objects to their corresponding silhouettes. Created for toddlers, preschoolers, and early learners (ages 3–8), this app builds essential visual and cognitive skills through hands-on, playful interaction.</p>
                                <p>Kids will explore scenes filled with everyday items, drag-and-drop puzzles, and charming visuals — all designed to make early learning enjoyable and meaningful.</p>
                                <h4>What Kids Will Learn:</h4>
                                <ul>
                                    <li><b>Visual Recognition:</b> Identify outlines and match them to real-world objects.</li>
                                    <li><b>Logical Thinking:</b> Use observation and reasoning to complete each level.</li>
                                    <li><b>Focus & Memory:</b> Sharpen concentration with progressive challenges.</li>
                                    <li><b>Cognitive Development:</b> Strengthen spatial awareness and pattern recognition./li>
                                </ul>
                                <h4>Key Features:</h4>
                                <ul>
                                    <li><b>Simple Drag & Drop Gameplay:</b> Children match items to their shadows with easy-to-use controls — no reading needed.</li>
                                    <li><b>Puzzles:</b> Enjoy themed levels featuring animals, toys, tools, and more.</li>
                                    <li><b>Kid-Friendly Interface:</b> Big buttons, gentle sounds, and clear visuals perfect for little hands.</li>
                                    <li><b>Offline & Ad-Free:</b> No ads or pop-ups, designed for safe play.</li>
                                    <li><b>Play Anytime, Anywhere:</b> Optimized for smooth play across devices and available offline.</li>
                                    <li><b>Progressive Challenge Levels:</b> The difficulty increases gradually to grow with your child's skills and confidence.</li>
                                </ul>
                                <h4>Who’s It For?</h4>
                                <ul>
                                    <li><b>Toddlers (Ages 3–4):</b> Discover basic shapes and practice early matching skills.</li>
                                    <li><b>Preschoolers (Ages 4–6):</b> Develop hand-eye coordination and short-term memory.</li>
                                    <li><b>Early Learners (Ages 6–8):</b> Tackle more complex puzzles and improve logical thinking.</li>
                                    <li><b>Parents & Teachers:</b> A reliable educational tool for focused playtime and learning.</li>
                                </ul>
                                <h4>Educational Benefits</h4>
                                <ul>
                                    <li>Encourages independent play and problem-solving.</li>
                                    <li>Supports early shape and object recognition.</li>
                                    <li>Enhances fine motor skills through interactive touch.</li>
                                    <li>Builds visual memory and sequencing skills.</li>
                                </ul>
                                <h4>About BabyApps</h4>
                                <p>Shadow Match Up is part of the trusted BabyApps learning series, developed to provide children with fun, skill-building experiences. Our studio — a recognized developer on Google Play — specializes in interactive apps that support early development in a safe and age-appropriate environment.</p>
                                <p>In collaboration with AppsNation and AppexGames, we focus on creating enriching experiences through intuitive design, high-quality visuals, and meaningful learning opportunities.</p>
                                <h4>Download Shadow Match Up Today</h4>
                                <p>Explore the magical world of shadows and shapes. Watch your child match, learn, and grow — one silhouette at a time!</p>
                            </div>
