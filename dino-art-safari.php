...
<head>
    ...
    <title>Dino Art Safari - Baby Apps</title>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/dino-art-safari/dino-art-safari-01.webp" class="img-fluid" alt="Dino Art Safari"></div>
                                <div><img src="assets/img/games/dino-art-safari/dino-art-safari-02.webp" class="img-fluid" alt="Dino Art Safari"></div>
                                <div><img src="assets/img/games/dino-art-safari/dino-art-safari-03.webp" class="img-fluid" alt="Dino Art Safari"></div>
                                <div><img src="assets/img/games/dino-art-safari/dino-art-safari-04.webp" class="img-fluid" alt="Dino Art Safari"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Dino Art Safari introduces young children to a colorful world of dinosaurs through drawing and coloring activities. Created for toddlers and early learners, the app encourages creativity, visual learning, and fine motor development in a playful prehistoric setting.</p>
                                <p>Children can color friendly dinosaurs, explore interactive scenes, and use various drawing tools designed for small hands. The app’s simple layout and gentle feedback make it suitable for ages 2 to 8.</p>
                                <h4>Features:</h4>
                                <ul>
                                    <li><b>Dinosaur Coloring Pages:</b> Paint a variety of dinosaur illustrations, including Stegosaurus, T-Rex, and Triceratops.</li>
                                    <li><b>Creative Drawing Tools:</b> Use crayons, brushes, spray paint, fill tools, and glitter pens.</li>
                                    <li><b>Interactive Prehistoric World:</b> Explore themed scenes with tap-to-color features and simple dino facts.</li>
                                    <li><b>Free Draw Mode: </b>Children can create their own artwork with no predefined lines.</li>
                                    <li><b>Offline Capabilities:</b> Play without needing an internet connection.</li>
                                    <li><b>Child-Friendly Design:</b> Easy-to-use interface with large buttons and visual feedback</li>
                                </ul>
                                <h4>Educational Benefits:</h4>
                                <ul>
                                    <li>Develops hand-eye coordination and fine motor skills.</li>
                                    <li>Promotes color recognition and creativity.</li>
                                    <li>Supports independent play and early artistic expression.</li>
                                    <li>Introduces basic dinosaur knowledge through themed content.</li>
                                </ul>
                                <h4>Who Is This Game For:</h4>
                                <ul>
                                    <li><b>Toddlers (Ages 2–4):</b> Gentle sensory exploration and coloring.</li>
                                    <li><b>Preschoolers (Ages 4–6):</b> Practice with drawing tools and recognizing shapes.</li>
                                    <li><b>Young Learners (Ages 6–8):</b> Creative expression through Free Draw mode.</li>
                                    <li><b>Parents & Educators: </b>A visual tool for early learning and quiet time activities.</li>
                                </ul>
                                <h4>About the Developers:</h4>
                                <p>Dino Art Safari is developed by BabyApps, in partnership with AppsNation and AppexGames. Our focus is creating digital experiences that blend creative exploration with learning for young children.</p>
                            </div>
