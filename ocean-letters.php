...
<head>
    ...
    <title>Ocean Letters - Baby Apps</title>
    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Ocean Letters</h1>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="http://play.google.com/store/apps/details?id=com.babyapps.abcgame.toddlers.oceanletters" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/ocean-letter/ocean-letter-01.webp" class="img-fluid" alt="Ocean Letters"></div>
                                <div><img src="assets/img/games/ocean-letter/ocean-letter-02.webp" class="img-fluid" alt="Ocean Letters"></div>
                                <div><img src="assets/img/games/ocean-letter/ocean-letter-03.webp" class="img-fluid" alt="Ocean Letters"></div>
                                <div><img src="assets/img/games/ocean-letter/ocean-letter-04.webp" class="img-fluid" alt="Ocean Letters"></div>
                                <div><img src="assets/img/games/ocean-letter/ocean-letter-05.webp" class="img-fluid" alt="Ocean Letters"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Learn the Alphabet Under the Sea!</p>
                                <p>Let your child explore the alphabet in a peaceful, underwater world filled with friendly sea creatures, floating bubbles, and gentle music. Ocean Letters turns ABC learning into a sensory-rich adventure designed especially for toddlers and preschoolers.</p>
                                <p>With soothing visuals, clear audio, and interactive letter play, this app helps children build early literacy skills in a calm and engaging environment.</p>
                                <h4>Features That Support Early Learning:</h4>
                                <ul>
                                    <li><b>Explore A to Z:</b> Tap and hear each letter from A to Z with voice narration and floating bubble animations.</li>
                                    <li><b>Multi-Sensory Learning:</b> Combines sound, touch, and visuals to reinforce letter recognition and memory.</li>
                                    <li><b>Designed for Toddlers:</b> Simple controls, large buttons, and age-appropriate pacing for young learners.</li>
                                    <li><b>Relaxed Gameplay:</b> No timers or scores — kids can play at their own speed in a low-pressure setting.</li>
                                    <li><b>Early Phonics Support:</b> Clear pronunciations help children connect letter shapes with their sounds naturally.</li>
                                </ul>
                                <h4>Built for Early Learners:</h4>
                                <p>Whether your child is just starting to recognize letters or practicing their ABCs, Ocean Letters offers a positive, pressure-free space for discovery. Its soothing marine theme promotes focus and supports:</p>
                                <ul>
                                ...
                                <h4>Parent-Friendly Benefits:</h4>
                                <ul>
                                    <li>Supports independent and guided play.</li>
                                    <li>Calming visuals and sound for a focused experience.</li>
                                    <li>Easy to use — no reading required.</li>
                                    <li>Great for travel, classrooms, or quiet time.</li>
                                </ul>
                                <h4>About BabyApps</h4>
                                <p>Ocean Letters is part of the educational app collection by BabyApps, a children’s app studio committed to creating high-quality digital learning tools for early childhood. With more than 20 playful titles, our mission is to turn screen time into skill-building time.</p>
                                <h4>Developed with Care</h4>
                                <p>Created in partnership with AppexGames and AppsNation, leaders in interactive education design. Their expertise ensures that every detail — from sound to screen layout — supports the learning goals of young children.</p>
                                <h4>Try It Today</h4>
                                <p>Make ABCs an underwater adventure!</p>
                                <p>Download Ocean Letters: Kids ABC Game and let your child discover letters through relaxing, hands-on play.</p>
                            </div>
