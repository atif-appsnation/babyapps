...
<head>
    ...
    <title>Colorful Compound - Baby Apps</title>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.babyapps.color.sortpuzzle.ColourfulCompounds" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/colorful-compounds/colorful-compounds-01.webp" class="img-fluid" alt="Colorful Compound"></div>
                                <div><img src="assets/img/games/colorful-compounds/colorful-compounds-02.webp" class="img-fluid" alt="Colorful Compound"></div>
                                <div><img src="assets/img/games/colorful-compounds/colorful-compounds-03.webp" class="img-fluid" alt="Colorful Compound"></div>
                                <div><img src="assets/img/games/colorful-compounds/colorful-compounds-04.webp" class="img-fluid" alt="Colorful Compound"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Colorful Compound is a vibrant color sorting puzzle game with a playful chemistry twist. Use logic, pattern recognition, and planning skills to organize colored liquids into the correct test tubes. With smooth animations, a clean design, and relaxing gameplay, this app offers a satisfying and brain-stimulating experience for all ages.</p>
                                <p>Whether you’re playing to relax, sharpen your focus, or enjoy a quick logic challenge, Colorful Compound makes it easy to play anywhere — no ads, no internet required.</p>
                                <h4>How to Play:</h4>
                                    <ul>
                                        <li>Tap a tube to pour the liquid from the top into another tube.</li>
                                        <li>Only liquids of the same color can be combined.</li>
                                        <li>Plan ahead to complete the puzzle in the fewest moves possible.</li>
                                        <li>Use undo or restart options if you get stuck.</li>
                                    </ul>
                                <h4>Features:</h4>
                                <ul>
                                    <li><b>Hundreds of Logic Levels:</b> From simple early levels to more complex puzzles.</li>
                                    <li><b>Smooth Visual Effects:</b> Fluid animations simulate pouring and mixing colors.</li>
                                    <li><b>Offline Play:</b> No Wi-Fi needed, works anywhere.</li>
                                    <li><b>One-Hand Friendly:</b> Play on the go with simple tap controls.</li>
                                    <li><b>Calming Soundtrack:</b> Gentle music and effects to support focused play.</li>
                                    <li><b>All Ages Welcome:</b> Easy to pick up, challenging to master.</li>
                                </ul>
                                <h4>Educational Benefits:</h4>
                                <ul>
                                    <li>Encourages problem-solving and planning.</li>
                                    <li>Enhances visual-spatial reasoning.</li>
                                    <li>Strengthens pattern recognition and sequencing skills.</li>
                                    <li>Provides engaging logic challenges in a science-themed environment.</li>
                                </ul>
                                <h4>Who Can Enjoy It:</h4>
                                <ul>
                                    <li><b>Kids (Ages 5–10):</b> Great for developing early thinking and reasoning skills.</li>
                                    <li><b>Teens and Students:</b> A creative logic break between learning sessions.</li>
                                    <li><b>Parents and Educators:</b> A safe, screen-time choice that supports cognitive growth.</li>
                                    <li><b>Puzzle Enthusiasts:</b> A relaxing, challenge-based puzzle game experience.</li>
                                </ul>
                                <h4>Developed by BabyApps</h4>
                                <p>Color Compound is developed by BabyApps, with design contributions from AppsNation and AppexGames. We focus on building thoughtful, creative apps that combine logic, learning, and engaging interaction — designed for kids, teens, and families who value smart digital play.</p>
                            </div>
