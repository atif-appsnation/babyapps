...
<head>
    ...
    <title>Happy Sorters - Baby Apps</title>
    ...
    <div class="breadcumb-wrapper" data-bg-src="assets/img/breadcumb/breadcumb-bg.jpg">
        <div class="container z-index-common">
            <div class="breadcumb-content">
                <h1 class="breadcumb-title">Happy Sorters</h1>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.babyapps.kids.sortmatch.learninggame" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/happy-sorters/happy-sorters-01.webp" class="img-fluid" alt="Happy Sorters"></div>
                                <div><img src="assets/img/games/happy-sorters/happy-sorters-02.webp" class="img-fluid" alt="Happy Sorters"></div>
                                <div><img src="assets/img/games/happy-sorters/happy-sorters-03.webp" class="img-fluid" alt="Happy Sorters"></div>
                                <div><img src="assets/img/games/happy-sorters/happy-sorters-04.webp" class="img-fluid" alt="Happy Sorters"></div>
                                <div><img src="assets/img/games/happy-sorters/happy-sorters-05.webp" class="img-fluid" alt="Happy Sorters"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Happy Sort is a vibrant sorting and matching game designed for young children to explore logic, categorization, and visual recognition through playful interactions. Built for ages 3 to 8, it supports early learning with simple drag-and-drop gameplay, cheerful animations, and progressive challenges.</p>
                                <p>Children can match and sort a variety of familiar objects — like toys, fruits, animals, and more — based on color, shape, size, or theme. With an intuitive layout and engaging visuals, Happy Sort provides a calm and enriching play experience that supports cognitive and motor development.</p>
                                <h4>What Kids Will Learn:</h4>
                                <ol>
                                    <li><b>Object Matching:</b> Identify and pair items that go together.</li>
                                    <li><b>Sorting Logic:</b> Group objects by category, shape, or color.</li>
                                    <li><b>Pattern Recognition:</b> Notice and match differences and sequences.</li>
                                    <li><b>Cognitive Skills:</b> Improve memory, focus, and attention.</li>
                                    <li><b>Fine Motor Skills:</b> Practice dragging, dropping, and organizing with control.</li>
                                </ol>
                                <h4>Key Features:</h4>
                                <ul>
                                    <li><b>Colorful Sort & Match Puzzles:</b> Includes everyday items such as food, clothing, animals, and toys.</li>
                                    <li><b>Multiple Sorting Modes:</b> Play by color, shape, size, or theme — or try the challenge mode for variety.</li>
                                    <li><b>Progressive Difficulty:</b> Levels adapt as children improve, supporting long-term engagement and learning.</li>
                                    <li><b>Kid-Friendly Interface:</b> Large buttons, joyful feedback, and easy-to-use controls designed for young children.</li>
                                    <li><b>Offline Compatible:</b> Enjoy the game on the go — available without an internet connection.</li>
                                </ul>
                                <h4>Who Can Play Happy Sort?</h4>
                                <ul>
                                    <li><b>Toddlers (Ages 3–4):</b> Introductory sorting and recognition.</li>
                                    <li><b>Preschoolers (Ages 4–6):</b> Practice matching and logical thinking.</li>
                                    <li><b>Early Learners (Ages 6–8): </b>Tackle more complex sorting patterns.</li>
                                    <li><b>Parents & Teachers:</b> A useful tool for structured play and early skill building</li>
                                </ul>
                                <h4>About the Developers:</h4>
                                <p>Happy Sort is created by BabyApps, with collaboration from AppsNation and AppexGames. Our focus is to develop meaningful digital learning experiences for young children by blending playful design with foundational educational goals.</p>
                            </div>
