...
<body>
    ...
    <section class="space-top space-extra-bottom">
        <div class="container">
            ...
            <div class="d-flex justify-content-between mt-4" id="paginationControls">
                <button class="vs-btn" id="prevBtn" style="display: none;">Previous</button>
                <button class="vs-btn ms-auto" id="nextBtn" style="display: none;">Next</button>
            </div>
        </div>
    </section>
    <!-- End Videos -->
