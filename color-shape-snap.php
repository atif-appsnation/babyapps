...
<head>
    ...
    <title>Color Shape Snap - Baby Apps</title>
            ...
            <div class="row">
                <div class="col-12 col-lg-9">
                    <div class="row">
                        <div class="col-lg-5">
                            <div class="d-flex">
                                ...
                                <a href="https://play.google.com/store/apps/details?id=com.babyapps.shape.color.match.ColorShapeSnap" target="_blank" class="ms-2">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="slider">
                                <div><img src="assets/img/games/color-shape-snap/color-shape-snap-01.webp" class="img-fluid" alt="Color Shape Snap"></div>
                                <div><img src="assets/img/games/color-shape-snap/color-shape-snap-02.webp" class="img-fluid" alt="Color Shape Snap"></div>
                                <div><img src="assets/img/games/color-shape-snap/color-shape-snap-03.webp" class="img-fluid" alt="Color Shape Snap"></div>
                                <div><img src="assets/img/games/color-shape-snap/color-shape-snap-04.webp" class="img-fluid" alt="Color Shape Snap"></div>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-12">
                            <div class="collapsible-text" id="collapsibleContent">
                                ...
                                <p>Color Shape Snap is an interactive learning game created to help young children explore basic shapes and colors through fun, hands-on play. Designed for toddlers, preschoolers, and early learners ages 2 to 6, this game blends education and creativity in a calm, ad-free environment.</p>
                                <p>Children match shapes and colors to complete playful images with cheerful animations and sound effects. With simple controls and thoughtful design, the app encourages early cognitive development, visual recognition, and problem-solving skills — all through joyful, independent play.</p>
                                <h4>Features:</h4>
                                    <ul>
                                        <li><b>Shape & Color Matching:</b> Drag and drop shapes to the correct spots to complete illustrations.</li>
                                        <li><b>Creative Coloring Play:</b> Tap and color using simple tools designed for little hands.</li>
                                        <li><b>Puzzle-Based Learning:</b> Supports logical thinking and early decision-making.</li>
                                        <li><b>Toddler-Friendly Design:</b> Big buttons, easy controls, and clear instructions.</li>
                                        <li><b>Offline:</b> no in-app purchases, and playable without internet.</li>
                                        <li><b>Joyful Sounds & Visuals:</b> Bright animations and engaging audio provide positive feedback.</li>
                                    </ul>
                                <h4>Educational Benefits:</h4>
                                <ul>
                                    <li>Supports early shape and color recognition.</li>
                                    <li>Enhances hand-eye coordination and motor skills.</li>
                                    <li>Promotes independent learning and focus.</li>
                                    <li>Builds confidence through trial-and-error exploration.</li>
                                </ul>
                                <p>Whether your child is just starting to explore colors and shapes or already enjoys solving simple puzzles, Color Shape Snap offers a safe and engaging environment for early learning.</p>
                                <h4>Who It’s For:</h4>
                                <ul>
                                    <li><b>Toddlers (2–4 years):</b> Explore basic shape and color identification.</li>
                                    <li><b>Preschoolers (4–6 years):<b> Strengthen early matching and logic skills.</li>
                                    <li><b>Parents & Educators:</b> Looking for a kid-safe educational game with no ads.</li>
                                </ul>
                                <h4>Created by BabyApps:</h4>
                                <p>Color Shape Snap is developed by BabyApps in collaboration with AppsNation and AppexGames. Our mission is to design playful digital tools that encourage creativity, learning, and joyful screen time for young children.</p>
                            </div>
